...
export default class Over extends Phaser.State {
    create() {
        if (otsimo.kv.over_screen.background_color) {
            this.game.stage.backgroundColor = otsimo.kv.over_screen.background_color;
        }
        if (otsimo.kv.over_screen.background_image) {
            let back = this.game.add.image(this.game.world.centerX, this.game.world.centerY, otsimo.kv.over_screen.background_image)
        ...
        console.log(otsimo.kv.test);
        console.log(otsimo.kv.ending_scene);
